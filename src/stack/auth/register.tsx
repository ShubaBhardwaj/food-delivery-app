...
export default function RegisterScreen() {
  ...
  const { register, bypassAuth, error, clearError } = useAuth();
  ...
  const handleRegister = async () => {
    ...
    if (success) {
      // Successfully registered, send them to Login screen
  ...
  const handleOfflineBypass = async () => {
    setValidationError(null);
    clearError();
    const cleanUsername = username.trim() || "DinerFan";
    const cleanEmail = email.trim() || "demo@lokaldiners.com";
    await bypassAuth(cleanUsername, cleanEmail);
  };
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.titleBlock}>
          ...
          <Text style={styles.subtitle}>Sign up to start order from local diners</Text>
        </View>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.inputWrapper}>
            <User size={20} color="#999" style={styles.fieldIcon} />
            <TextInput
          ...
          {isBypassVisible && (
            ...
            >
              <Text style={styles.bypassButtonText}>Bypass & Register Offline (Demo Mode)</Text>
            </Pressable>
          )}
        </View>
